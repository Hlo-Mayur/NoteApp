...
/**
 * @fileOverview Tag suggestion AI agent.
 *
...
const suggestTagsPrompt = ai.definePrompt({
  ...
  prompt: `You are a tag suggestion expert. Given the following note content, suggest relevant tags that can be used to categorize the note. Return the tags as a JSON array of strings.
